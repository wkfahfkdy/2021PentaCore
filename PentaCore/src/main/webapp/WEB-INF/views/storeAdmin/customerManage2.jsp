...
$.ajax({
	url:'../store/expiredList',	// HomeController > 나중에 위치 변경
	dataType:'json',
	success:function(data){
		// TOAST GRID
		const recruitGrid = new tui.Grid({
...
error: function(err){
	...
	<div class="title-group" style="margin-top: 70px; align:center;">
		...
		<form id="frm" name="frm"  action="../store/storageUserDetail">
		...
		<form id="frm2" name="frm2"  action="store/storageExpiredUserDetail">
